    ...
    return (
        <div className='md:w-1/2 text-justify'>
            ...
            <div className='bg-gray-200 p-2 mb-5 mt-2'>
                ...
                <div>
                    <p>Your rental agreement offers, for an additional charge, an optional waiver to cover all or a part of your responsibility for damage to or loss of the vehicle; Before deciding whether to purchase the walver, you may wish to determine whether your own automobile insurance or credit card agreement provides you coverage for rental vehicle damage or loss and determine the amount of the deductible under your own insurance coverage. The purchase of the waiver is not mandatory. The waiver is not insurance. I acknowledge that I have received and read a copy of this.</p>
                    <br />
                    <p className='mt-4'>Renters Signature</p>
                    <p className='mb-5 mt-2'>_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _</p>
